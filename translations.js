...
window.translations = {
  en: {
    ...
    title: "Juan Vásquez",
    cv: "cv",
    updated: "Updated 15.MAY.2025",
    
    // Navigation
    contents: "Contents",
    intro: "intro",
    contact: "contact",
    acpublications: "academic publications",
    teaching: "teaching",
    ...
    courseMaterials: "Materials created for the course available",
    here: "here",
    spanish: "(in Spanish)",
    
    // Other work section
    organizerRole: "Organizer",
    attendingStudent: "Attending student",
    programCommittee: "Program commitee member",
    presenter: "Presenter",
    ...
    researchersIntro: "These are some researchers whose work I follow closely, and that I find very cool/interesting. Check out their work if you want to learn more about various areas in Computer Science :)",
    
    // Research areas
    compAnalConv: "→ computational analysis of conversations",
    compSocSci: "→ computational social science",
    dataProtection: "data & tech protection, governance, privacy and governance",
    deepfakes: "→ deepfakes & llm-generated content detection",
    ethics: "→ ethics in ai & nlp",
    formalLanguages: "→ formal languages & neural networks",
    formalSemantics: "→ formal semantics / semantic representations",
    grounded: "→ grounded language acquisition",
    compLinguistics: "→ linguistics / computational linguistics",
    llmDesign: "→ llm design, evaluation & analysis",
    llmFairness: "→ llm fairness & debiasing",
    logic: "→ logic / theorem proving",
    neurosymbolic: "→ neurosymbolic nlp",
    probabilisticProgramming: "→ probabilistic programming",
    ppls: "→ programming languages",
  ...
  es: {
    ...
    title: "Juan Vásquez",
    cv: "cv",
    updated: "Actualizado 15.MAY.2025",
    ...
    // Intro section
    introText: `Soy Juan Vásquez (él), un estudiante de doctorado de segundo año en Ciencias de la Computación en la Universidad de Colorado Boulder. Estoy siendo supervisado por <a href="https://blast-cu.github.io/mlpacheco/">Dra. Maria L. Pacheco</a> y <a href="https://alexispalmer.github.io/">Dra. Alexis Palmer</a>.`,
    introText2: `Soy parte de <a href="https://blast-cu.github.io/">BLAST</a> y <a href="https://lecs-lab.github.io/">LECS</a>, donde actualmente trabajo en enfoques neurosimbólicos para PLN. Nuestro objetivo es combinar reglas y métodos simbólicos con arquitecturas neuronales para aprovechar las capacidades de modelado que muestran ambos paradigmas, y crear modelos de PLN más robustos, eficientes y explicables.`,
    ...
    researchersIntro: "Estos son algunos investigadores cuyo trabajo sigo de cerca, y que encuentro muy genial/interesante. Revisa su trabajo si quieres aprender más sobre varias áreas en Ciencias de la Computación :)",
